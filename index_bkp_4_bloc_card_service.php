            ...
            <div id="bloc_links" class=" col-md-8 text-md-right">
                ...
                <div class="dropdown show">
                    ...
                    <div class="dropdown-menu" aria-labelledby="servicedrop">
                        ...
                        <a href="#" class="dropdown-item mr-lg-4 mr-md-3 link"> Cours de langue </a>
        ...
        <section id="sec_serv" class="">
            ...
            <!-- <div class="row col-lg-10 mx-auto p-0">
                ...
                <div class="col-lg-3 p-0">
                    <div id="domicile" class="content row col-11 p-0 m-0 mx-auto">
                        <div class="card">
                        ...
                        <div class="p-4">
                            ...
                            <button class="btn btn-dark"> voir details </button>
                        </div>    
                    </div>
                </div>

                <div class="col-lg-3 p-0">
                    <div id="langue" class="content row col-11 p-0 m-0 mx-auto">
                        <div class="card">
                            <img src="./ressources/img/onebook.jpg" alt="" class="card-img-top card_img">
                        </div>
                        <div class="p-4">
                ...
                <div class="col-lg-3 p-0">
                    <div id="domicile" class="content row col-11 p-0 m-0 mx-auto">
                        ...
                        <div class="p-4">
                            ...
                            <p class="">
                                M2D c’est des services de TRADUCTION pour vos documents avec une traduction professionnelle 
                            </p>
                            <button class="btn btn-dark"> voir details </button>
                        </div>
                ...
                <div class="col-lg-3 p-0">
                    <div id="langue" class="content row col-11 p-0 m-0 mx-auto">
                        ...
                        <div class="p-4">
                            ...
                            <p class="">
                                Toujours dans l’optique de vous satisfaire M2D vous propose aussi une LIBRAIRIE
                            </p>
                            <button class="btn btn-dark"> voir details </button>
                        </div>
            ...
            <div class="row col-lg-10 mx-auto">
                ...
                <div class="col-lg-6 p-0 mb-lg-4">
                    <div class="content row col-11 mx-auto p-0">
                ...
                <div class="col-lg-6 p-0 mb-lg-4">
                    <div class="content row col-11 mx-auto p-0">
                        ...
                        <div class="col-md-8 col-sm-7 p-4">
                            ...
                            <p class="">
                                Toujours dans l’optique de vous satisfaireM2D vous propose aussi une LIBRAIRIE 
                            </p>
                            <button class="btn btn-dark"> voir details </button>
                        </div>
