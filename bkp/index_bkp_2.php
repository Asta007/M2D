...
<body>
        ...
        <div id="nav_content" class="row col-11 mx-auto p-0">
            ...
            <div id="bloc_links" class=" col-md-8 text-md-right">
                ...
                <div class="dropdown show">
                    <button href="" id="servicedrop" class="link_con btn btn-link dropdown-toggle" data-toggle="dropdown" type="button"> services </button>
                    <div class="dropdown-menu" aria-labelledby="servicedrop">
                        <a href="#" class="dropdown-item mr-lg-4 mr-md-3 link"> Cours a domicile </a>
                        <a href="#" class="dropdown-item mr-lg-4 mr-md-3 link"> Interpretariat / Traduction </a>
                        <a href="#" class="dropdown-item mr-lg-4 mr-md-3 link"> Librairie </a>
                        
                    </div>
                </div>
                <a href="#" class="mr-lg-4 mr-md-3 link"> a propos </a>
                <a href="#sec_rejoindre" class="mr-lg-4 mr-md-3 link"> contacts </a>
                <a href="#" class="mr-lg-4 mr-md-3 link"> connexion </a>
            </div>
    ...
    <div id="pagebody">
        ...
        <section id="sec_serv" class="">
            ...
            <div class="row col-lg-10 mx-auto p-0">
                
                <div class="col-lg-6 p-0 mb-lg-5">
                    <div id="librairie" class="content row col-11 p-0 m-0 mx-auto">
        
                        <div class="card">
                            <img src="./ressources/img/onebook.jpg" alt="" class="card-img-top card_img">
                        </div>
                        <div class="p-4">
                            <p class="card_title">
                                Cours a domicile
                            ...
                            <p class=" text-justify">
                                ...
                                Plus de lacune ni d’échec ! <p>
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item"> Matières scientifiques : Mathématiques, physique-chimie, svt </li>
                                    <li class="list-group-item"> Matières littéraires : Français, HG, Philo </li>
                                    <li class="list-group-item">Informatique, Comptabilité, Technique d’expression et de communication</li>
                                </ul>
                                <p>
                                    Avec un suivi sur mesure pour renforcer, rattraper toutes les lacunes, ou même remotiver votre enfant
                                </p>
                ...
                <div class="col-lg-4 p-0 mb-lg-5">
                    <div id="cours_langue" class="content row col-11 p-0 m-0 mx-auto">
                        ...
                        <div class="p-4">
                            ...
                            <p class=" text-justify">
                                ...
                                M2D est la solution avec ses cours de : <br>
                                FRANÇAIS, ANGLAIS, ESPAGNOL, ARABE/ CORAN, WOLOF, PULAAR,  SERERE 
                                Pour ainsi élargir les perspectives professionnelles ou scolaires, développer ses opportunités, découvrir de nouvelles cultures et s’ouvrir au monde.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 p-0 mb-lg-5">
                    <div id="inter_trad" class="content row col-11 p-0 m-0 mx-auto">
                ...
                <!-- <div class="col-lg-4 p-0 mb-lg-5">
                    <div id="lib" class="content row col-11 p-0 m-0 mx-auto">
                        ...
                        <div class="p-4">
                            ...
                            <p class=" text-justify">
                                Toujours dans l’optique de vous satisfaireM2D vous propose aussi une LIBRAIRIE avec des fournitures scolaire et bureautiques de qualité avec une livraison gratuite.
                                <br>
                                <br>
                                <br>
                            </p>
                ...
                <div id="" class="row mx-auto content">

                    <div class="col-md-8 col-sm-7 p-4">
                        <p class="text-justify">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deleniti excepturi odit tenetur.
                            Recusandae magnam aspernatur in et cum incidunt accusamus repudiandae quaerat molestiae, quae
                            vel inventore consequuntur! Ad, ut sapiente!
                        </p>
                        <p class="question">
                            Comment Commander ?
                        </p>
                        <p class=" text-justify">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad accusantium nulla reiciendis, a qui
                            animi adipisci nam
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad accusantium nulla reiciendis, a qui
                            animi adipisci nam
                        </p>
                    ...
                    <div class="col-md-4 col-sm-5 text-sm-left text-center p-0">
                        <img class="card_side_img" src="./ressources/img/onebook.jpg" alt="">
                    </div>
                </div>
